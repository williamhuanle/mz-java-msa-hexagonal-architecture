...
import mz.co.kr.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User processOAuth2User(OAuth2UserRequest oAuth2UserRequest, OAuth2User oAuth2User) {
        ...
        Optional<UserDto> userOptional = userServicePort.findByEmail(oAuth2UserInfo.getEmail());
        UserDto user;
    ...
    private UserDto updateExistingUser(UserDto existingUser, OAuth2UserInfo oAuth2UserInfo) {
        ...
        return userServicePort.save(existingUser);
    }
